    ...
    <div class="col-md-12 ">
        <div class="card border-0 shadow-lg rounded">
            <div class="card-header bg-success ">
                <h5 class="text-center text-white mb-0">Account Transaction Report</h5>
            </div>
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <form action="{{ route('admin.accounts.transaction.report_generate') }}" method="POST" id="" class="form-inline">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <label for="" class="form-label">Master Ledger Name</label>
                                    <select name="master_ledger_id" id="master_ledger_id" class="form-control shadow-sm" required>
