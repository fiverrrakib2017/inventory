                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <select name="sub_ledger_id" id="sub_ledger_id" class="form-control " required>
                                    <option value="">---Select---</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3 d-flex align-items-end">
                                <button type="button" data-toggle="modal" data-target="#addModal" class="btn btn-primary mt-4 btn-block w-100">Add Sub Ledger</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-3 d-flex align-items-end">
                                <button type="submit" class="btn btn-success mt-4 btn-block w-100">Submit</button>
                            </div>
                        </div>
                    </div>
                </form>
