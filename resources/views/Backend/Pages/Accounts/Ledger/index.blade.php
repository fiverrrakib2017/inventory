                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group mb-2">
                            ...
                            <select type="text" name="master_ledger_name" class="form-control select2"  required>
...
<div id="deleteModal" class="modal fade">
    <div class="modal-dialog modal-confirm">
        <form action="{{route('admin.ledger.delete')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      var table=$("#datatable1").DataTable({
        ...
        ajax: "{{ route('admin.ledger.all_data') }}",
        language: {
    ...
    $('#datatable1 tbody').on('click', '.edit-btn', function () {
      var id = $(this).data('id');
      var editUrl = '{{ route("admin.ledger.edit", ":id") }}';
      ...
      $.ajax({
          ...
          success: function (response) {
              if (response.success) {
                ...
                $('#editModal select[name="master_ledger_name"]').val(response.data.master_ledger.id);
                $('#editModal input[name="ledger_name"]').val(response.data.ledger_name);
