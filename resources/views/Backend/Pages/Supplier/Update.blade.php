                    ...
                    <div class="section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select type="text"  class="form-control select2" name="marital_status">
                    ...
                    <div class="section">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select type="text" class="form-control select2" name="verification_status">
                    ...
                    <div class="section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select type="text" class="form-control select2" name="bank_payment_status">
