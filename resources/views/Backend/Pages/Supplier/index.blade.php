        ...
        <div class="col-md-12 ">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.supplier.create') }}" class="btn btn-success mb-2"><i
                            class="mdi mdi-account-plus"></i>Add New Supplier</a>
                </div>
                <div class="card-body">
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            var link = "{{ route('admin.supplier.view', ':id') }}".replace(':id',
                                row.id);
                    ...
                    },
                    {
                        data: null,
                        render: function(data, type, row) {
                            var editUrl = "{{ route('admin.supplier.edit', ':id') }}".replace(':id',
                                row.id);
                            var viewUrl = "{{ route('admin.supplier.view', ':id') }}".replace(':id',
                                row.id);
